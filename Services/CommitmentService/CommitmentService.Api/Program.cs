...
try
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "CommitmentService");
    ...
    {
        var context = scope.ServiceProvider.GetRequiredService<CommitmentServiceDbContext>();
        ...
        {
            context.Database.ExecuteSql($"DROP SCHEMA [Commitment]");

            context.Database.ExecuteSql($"DELETE from __EFMigrationsHistory where MigrationId like '%_Commitment_%';");
        }
